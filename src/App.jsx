...
function App() {
  ...
  const getDataExcuse = async (excuse1) => {
    try {
      let respone = await axios.get(`https://api.themoviedb.org/3/trending/movie/day?api_key=3fe72b1756e8dee6cb18cad4c6b9de27`)
      ...
      <div id='con'>
        <nav className='d-flex justify-content-between bg-dark p-1 '>
          <div className='d-flex p-1 mx-2'>
            <span className='align-self-center text-white'>MovieApp DB</span>
